...
import { products as tops } from './WomenTops';
...
const WomenTopDetail = () => {
  ...
  const product = tops.find((p) => p.id === id);
  ...
  // Function to handle tag click and navigate to the tops page with the tag filter
  const handleTagClick = (tag: string) => {
    navigate(`/women/tops?tag=${encodeURIComponent(tag)}`);
  };
