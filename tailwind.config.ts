		...
		extend: {
			...
			keyframes: {
				...
				'cart-attention': {
					...
					'50%': { transform: 'scale(1.02)', boxShadow: '0 0 0 10px rgba(59, 130, 246, 0)' },
			...
			animation: {
				...
				'cart-attention': 'cart-attention 1.5s ease-in-out infinite',
				'cart-badge-pulse': 'cart-badge-pulse 2s infinite'
			}
		}
	},
